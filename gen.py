...
def generate_content(url,file_name):
    ...
    textsi_1 = """you are documnent extractor who  extarct data related to the gas service alone.Avoid adding special characters or formatting outside of a valid JSON structure"""
